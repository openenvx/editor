...
- Update build configurations and publishing process
...
- Streamline exports and remove unused types in core modules

- Updated exports in `backbone.ts` to use type exports for `EditorRuntime`, `Layer`, and `Scene`, enhancing clarity.
...
- Remove CHANGELOG.md and update publishing instructions

- Deleted the CHANGELOG.md file to streamline documentation.
- Updated PUBLISHING.md to clarify the use of granular publish tokens and bypass-2FA requirements.
