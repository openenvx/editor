...
| Declarative embed plugin panels | **Partial** | Pro + protocol | `@openenvx/plugin-protocol`, `PluginPanelPlugin` (`packages/workbench/src/plugin-panel/`) | Parent-hosted JSON trees rendered with Studio primitives. Hosted bundles / dashboard Studio / canvas widgets deferred. |
