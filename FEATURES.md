...
| Rich text editing | **Partial** | OSS | TipTap overlay (`canvas-rich-text-editor.tsx`), `data.html` | On-canvas bold / italic / underline / strike. **No inline color or per-span font family/size yet.** |
