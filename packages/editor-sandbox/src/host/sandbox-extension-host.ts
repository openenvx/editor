...
import { validatePluginTree } from '../protocol';
import { createSandboxHostSurface } from './create-host-surface';
import { createExtensionContributions } from './panel-tree/create-extension-contributions';
import { extensionSurfaceStore } from './panel-tree/extension-surface-store';
...
export function mountSandboxExtensions(
  ...
  const surface = createSandboxHostSurface(api, (disposable) => {
